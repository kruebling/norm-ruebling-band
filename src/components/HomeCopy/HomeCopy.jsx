  ...
  return <div className="h-96">
      ...
      <div className="container flex justify-end h-80">
        <p className="w-1/2 font-sans leading-normal text-gray-dk text-sm mr-12 pt-10 pr-24">
          ...
          chances are you were diggin' the NORM RUEBLING BAND.<br /><br />
          
          Whether we are
          rocking your wedding, anniversary, convention, a mixer, or any
          special occasion, NRB excels. We will leave you wondering...how do
          they bring it like that every night.
        </p>
      </div>
    </div>;
}
